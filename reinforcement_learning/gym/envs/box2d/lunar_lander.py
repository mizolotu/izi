...
from reinforcement_learning.gym.utils import seeding, EzPickle
...
class LunarLander(EzPickle):
    ...
    def step(self, action):
        ...
        if not self.lander.awake:
            ...
            reward = +100
        return np.array(state, dtype=np.float32), reward, done, {'r': reward, 'n': 0, 'a': 0, 'p': 0}

    def render(self, mode='human'):
        from reinforcement_learning.gym.envs.classic_control import rendering
