...
from reinforcement_learning.common.save_util import data_to_json, json_to_data, params_to_bytes, bytes_to_params
from reinforcement_learning.common.policies import get_policy_from_name, ActorCriticPolicy
from reinforcement_learning.common.runners import AbstractEnvRunner
from reinforcement_learning.common.vec_env.base_vec_env import VecEnvWrapper, VecEnv
from reinforcement_learning.common.vec_env.dummy_vec_env import  DummyVecEnv
from reinforcement_learning.common.vec_env.vec_normalize import VecNormalize
from reinforcement_learning.common.vec_env import unwrap_vec_normalize
from reinforcement_learning.common.callbacks import BaseCallback, CallbackList, ConvertCallback
...
class BaseRLModel(ABC):
    ...
    def _setup_learn(self):
        ...
        if self.ep_info_buf is None:
            self.ep_info_buf = deque(maxlen=10 * self.n_envs)
