...
from reinforcement_learning.gym.spaces import Discrete, Box
from collections import deque

from reinforcement_learning import logger
from reinforcement_learning.common.schedules import Scheduler
from reinforcement_learning.common.tf_util import batch_to_seq, seq_to_batch, check_shape, avg_norm, gradient_add, q_explained_variance, total_episode_reward_logger
from reinforcement_learning.acer.buffer import Buffer
from reinforcement_learning.common import ActorCriticRLModel, tf_util, SetVerbosity, TensorboardWriter
...
class _Runner(AbstractEnvRunner):
    ...
    def __init__(self, env, model, n_steps):
        ...
        self.mb_obs, self.mb_actions, self.mb_mus, self.mb_dones, self.mb_rewards = [], [], [], [], []
