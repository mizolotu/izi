...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "ovs_0" do |ovs_0|
    ...
    ovs_0.vm.network :private_network, :ip => "192.168.254.21"
  ...
  config.vm.define "ovs_1" do |ovs_1|
    ...
    ovs_1.vm.network :private_network, :ip => "192.168.254.22"
  ...
  config.vm.define "ovs_2" do |ovs_2|
    ...
    ovs_2.vm.network :private_network, :ip => "192.168.254.23"
  ...
  config.vm.define "ids_0_0" do |ids_0_0|
    ...
    ids_0_0.vm.network :private_network, :ip => "192.168.254.61"
  ...
  config.vm.define "ids_0_1" do |ids_0_1|
    ...
    ids_0_1.vm.network :private_network, :ip => "192.168.254.62"
  ...
  config.vm.define "ids_1_0" do |ids_1_0|
    ...
    ids_1_0.vm.network :private_network, :ip => "192.168.254.63"
  ...
  config.vm.define "ids_1_1" do |ids_1_1|
    ...
    ids_1_1.vm.network :private_network, :ip => "192.168.254.64"
...
config.vm.define "ids_2_0" do |ids_2_0|
    ...
    ids_2_0.vm.network :private_network, :ip => "192.168.254.65"
  ...
  config.vm.define "ids_2_1" do |ids_2_1|
    ...
    ids_2_1.vm.network :private_network, :ip => "192.168.254.66"
